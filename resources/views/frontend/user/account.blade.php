                            ...
                            <div class="row">
                                <div class="col-12 col-lg-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" id="firstName" name="full_name"
                                            value="{{ $user->full_name }}" placeholder="eg. tal7aouy">
                                        @error('full_name')
                                ...
                                <div class="col-12 col-lg-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" id="displayName"
                                            value="{{ $user->username }}" name="username" placeholder="eg. Raidai">
                                        @error('username')
                                            <p class="text-danger">{{ $message }}</p>
                                        @enderror
                                    </div>
                                ...
                                <div class="col-12">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" id="displayName"
                                            placeholder="eg. 9807009889" name="phone" value="{{ $user->phone }}">
                                        @error('phone')
                                            <p class="text-danger">{{ $message }}</p>
                                        @enderror
                                    </div>
                                ...
                                <div class="col-12">
                                    <div class="form-group">
                                        ...
                                        <input type="email" class="form-control" id="emailAddress" name="email"
                                            placeholder="eg. prajwal.iar@gmail.com" value="{{ $user->email }}" disabled>
                                    </div>
                                </div>
                                <div class="col-12">
                                    <div class="form-group">
